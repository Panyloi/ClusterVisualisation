...
# ax.scatter(x_points/(10**7), y_points/(10**7), s=1)
...
#     zipped_points = np.vstack((gruped_points[categorized_names[i]]["x"], 
#                                gruped_points[categorized_names[i]]["y"]))
#     zipped_points = zipped_points/(10**7)
...
#     if len(zipped_points[0]) < 3:
#         continue
    
#     convex_hull_points, edge_points = concave_hull(zipped_points, alpha=0.3)
