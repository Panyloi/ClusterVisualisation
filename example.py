...
draw_maps("data/size-12/mds_ged_blp_2d.csv", "pngs/size-12/mds_ged_blp_2d_daq", config_id='divide_and_conquare')
draw_maps("data/size-12/mds_katz_cen_2d.csv", "pngs/size-12/mds_katz_cen_2d_daq", config_id='divide_and_conquare')
draw_maps("data/size-12/mds_sph_2d.csv", "pngs/size-12/mds_sph_2d_daq", config_id='divide_and_conquare')
draw_maps("data/size-12/mds_sphr_2d.csv", "pngs/size-12/mds_sphr_2d_daq", config_id='divide_and_conquare')
draw_maps("data/size-12/pca_katz_cen_2d.csv", "pngs/size-12/pca_katz_cen_2d_daq", config_id='divide_and_conquare')
e = time.time()
print(f"{e-s}s")
